...
Phases 0–10 contain the complete specified product: curated-data schemas, Decimal calculation engine, Supabase persistence, market and wallet ingestion, calculation transparency, public product routes, provider status, retention, error handling, SEO, accessibility, and production runbooks. The repository does not contain production curated data, authentication, or an admin system.
